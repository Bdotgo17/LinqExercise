...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var filtered =
                employees.Where(person => person.FirstName[0] == 'C' || person.FirstName[0] == ('S'))
            ...
            {
                Console.WriteLine($"First name: {person.FirstName} Age: {person.Age} YOE: {person.YearsOfExperience}");
            }
